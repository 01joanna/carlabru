export default function AltHeader() {
    return (
        <header className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 z-20 w-auto h-auto text-md font-oatmealLight uppercase tracking-wider flex mt-14 gap-64 bg-transparent text-white">
            <nav className="">
