    ...
    return (
        <header className="absolute top-0 right-0 lg:left-1/2 lg:-translate-x-1/2 -translate-y-1/2 z-20 w-screen h-auto text-md font-oatmealLight uppercase tracking-wider flex mt-14 bg-transparent text-white lg:mx-0 mx-10 justify-around">
            ...
            <a
                ...
                className="uppercase border border-gray-400 rounded-lg px-7 py-2 hidden lg:flex"
            >
                Contacto
            </a>
            ...
            {/* MENÚ MÓVIL */}
            {isOpen && (
                <div className="absolute top-full right-0 mt-2 bg-black text-white border border-gray-400 rounded-lg px-6 py-4 flex flex-col gap-4 lg:hidden z-30">
                    <a href="/">Inicio</a>
                    <a href="/information">Información</a>
                    <a href="/projects">Proyectos</a>
                    <a href="mailto:carla@ejemplo.com">Contacto</a>
                </div>
            )}
        </header>
    );
