export default function Information() {
    return (
        <section className="font-helvetica tracking-wider mx-30 my-36 text-sm w-full bg-black text-white">
            <div className="flex gap-[10rem]">
                <div className="w-1/3 flex flex-col gap-20 font-oatmealLight text-lg">
                    <div>
                ...
                <div className="w-1/2 flex flex-col gap-20 font-oatmealExtraLight text-lg">
